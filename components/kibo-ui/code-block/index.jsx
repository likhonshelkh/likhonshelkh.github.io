...
const lineNumberClassNames = cn(
  ...
  '[&_.line]:before:text-slate-500/50 dark:[&_.line]:before:text-slate-400/50',
...
const codeBlockClassName = cn(
  'mt-0 bg-white text-sm dark:bg-slate-950',
  '[&_pre]:py-4',
...
export const CodeBlockHeader = ({ className, ...props }) => (
  <div
    className={cn(
      'flex flex-row items-center border-b bg-slate-100 p-1 dark:bg-slate-800',
      className,
    )}
    {...props}
  />
...
export const CodeBlockFilename = ({
  ...
  return (
    <div
      className="flex items-center gap-2 bg-slate-100 px-4 py-1.5 text-slate-500 text-xs dark:bg-slate-800 dark:text-slate-400"
      {...props}
    >
...
export const CodeBlockSelectTrigger = ({ className, ...props }) => (
  <SelectTrigger
    className={cn(
      'w-fit border-none text-slate-500 text-xs shadow-none dark:text-slate-400',
      className,
    )}
    {...props}
  />
...
export const CodeBlockSelectContent = ({ children, ...props }) => {
  const { data } = useContext(CodeBlockContext);
